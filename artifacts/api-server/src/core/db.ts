...
const SCHEMA: string[] = [
  ...
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS score integer`,
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS prev_score integer`,
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS score_delta integer`,
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS mc_delta_pct real`,
  ...
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS survival jsonb`,
  `ALTER TABLE desk_memory ADD COLUMN IF NOT EXISTS rug text`,
  `ALTER TABLE f2_tokens ADD COLUMN IF NOT EXISTS last_rug text`,
  `ALTER TABLE f2_tokens ADD COLUMN IF NOT EXISTS last_survival jsonb`,
